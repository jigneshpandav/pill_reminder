...
import 'package:medicine_reminder/widgets/date_picker/style.dart';
import 'package:medicine_reminder/widgets/date_picker/tap.dart';
...
class _DatePickerState extends State<DatePicker> {
  ...
  void initState() {
    ...
    selectedDateStyle = widget.dateTextStyle
        .copyWith(color: widget.selectedTextColor, fontWeight: gilroyBold);
    selectedMonthStyle =
        widget.monthTextStyle.copyWith(color: widget.selectedTextColor);
    selectedDayStyle = widget.dayTextStyle
        .copyWith(color: widget.selectedTextColor, fontWeight: gilroyMedium);
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        controller: ScrollController(
            initialScrollOffset: (widget.height -32) * _currentDate!.day),
